...
public class SplashScreen extends Activity {
	...
	private void shareApp(){
		...
		intent.putExtra(android.content.Intent.EXTRA_TEXT,"https://play.google.com/store/apps/details?id=com.pilotpol.thaipilotpray");
		intent.putExtra(android.content.Intent.EXTRA_STREAM,R.drawable.sc_shot_a);
		startActivity(Intent.createChooser(intent, "ร่วมเผยแพร่ เป็นธรรมทาน ผ่าน"));
	}
}// end Activity class
